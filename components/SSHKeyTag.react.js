...
export default class SSHKeyTag extends Component {
    ...
    render() {
        ...
        return (
            <div className='sshKeyTag' onClick={onClick}>
                <svg width='20px' height='20px' className='keyLogo'>
                    <g stroke="none" fill="#F5F7FA" transform='translate(0,0)'>
                ...
                {ssh_key.fingerprint || ssh_key.fingerprint}
            </div>
        );
    }
};
