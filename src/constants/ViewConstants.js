...
CONTRACTOR_VIEWS[VIEW_TYPES.COMPLETED] = {name: 'Closed', icon: 'img/completed-24px.svg', type: VIEW_TYPES.COMPLETED },
...
MANAGER_VIEWS[VIEW_TYPES.COMPLETED] = { name: 'Closed', icon: 'img/completed-manager-24px.svg', type: VIEW_TYPES.COMPLETED },
