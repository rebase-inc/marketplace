...
var App = React.createClass({
    getInitialState: function() {
        return {
            ...
            views: [
                { name: 'New/Waiting', element: <NewTicketView tickets={this.props.tickets}/>, icon: 'img/new-waiting-24px.svg', selected: true },
...
var TICKETS = [
    ...
    {title: 'Change bank account model initialization method to take a generic owner parameter.', date: '4', skillsRequired: 'Python | SQLAlchemy | Finite State Machine', comments: ['Foo','Bar']},
    {title: 'Do this one thing and then the other thing so we have more things to do.', date: '6', skillsRequired: 'Python | SQLAlchemy | Finite State Machine', comments: ['Foo','Bar']},
    {title: 'Delete every line of code from the codebase, destroy everybody\'s computers, and delete our github accounts.', date: '7', skillsRequired: 'Python | SQLAlchemy | Finite State Machine', comments: ['Foo','Bar']},
    {title: 'Play with the quadcopter for 10-15 hours.', date: '8', skillsRequired: 'Python | SQLAlchemy | Finite State Machine', comments: ['Foo','Bar']},
    {title: 'Build some really cool software, get a bunch of people to use it, and make a billion dollars.', date: '9', skillsRequired: 'Python | SQLAlchemy | Finite State Machine', comments: ['Foo','Bar']},
];

React.render(<App tickets={TICKETS}/>, document.body);
